                            ...
                            <div className="inner-column wow fadeInLeft">
                                ...
                                <div className="pricing-block">
                                    <div className="inner-box">
                                        <figure className="image"><img src="/images/resource/pricing-1.png" title='Netvions' /></figure>
                                ...
                                <div className="pricing-block style-two pull-left">
                                    <div className="inner-box">
                                        <figure className="image"><img src="/images/resource/pricing-2.png" title='Netvions' /></figure>
                                        <div className="price-box">
