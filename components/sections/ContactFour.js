                        ...
                        <div className="info-column col-lg-7 col-md-12 col-sm-12">
                            <div className="inner-column wow fadeInRight">
                                ...
                                <div className="our-values">
                                    <figure className="image"><img src="/images/resource/our-value.jpg" title='Netvions' /></figure>
                                ...
                                <div className="info-box">
                                    <figure className="image"><img src="/images/resource/our-value-2.jpg" title='Netvions' /></figure>
