                        ...
                        <div className="row">
                            ...
                            <div className="feature-block-six col-lg-4 col-md-6 col-sm-12">
                                <div className="inner-box ">
                                    ...
                                    <Link href="/our-services" className="theme-btn btn-style-two small hvr-light"><span className="btn-title">Find Your Solution</span></Link>
                                </div>
                            </div>
                            {/* Feature Block Six */}
                            <div className="feature-block-six col-lg-4 hide-md ">
                                <div className="inner-box ">
                                    <figure className="image"><img src="/images/resource/feature-bg-6.jpg" title='Netvions' /></figure>
                                </div>
                            </div>
                            {/* Feature Block Six */}
                            <div className="feature-block-six col-lg-4 col-md-6 col-sm-12">
