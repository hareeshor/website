            ...
            >
                <SwiperSlide>
                    ...
                    <div className="slide-item">
                        <div className="bg-image" style={{ backgroundImage: 'url(images/main-slider/5.jpg)' }} />
                        <div className="auto-container">
                            <div className="content-box">
                                ...
                                <div className="btn-box animate-3">
                                    <Link href="/about-us" className="theme-btn btn-style-one hvr-light"><span className="btn-title">Discover more</span></Link>
                                </div>
                            </div>
                        </div>
                    </div>
