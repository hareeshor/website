            ...
            >
                {/* {data.map((item, i) => ( */}
                    <SwiperSlide className="testimonial-block-three">
                        <div className="inner-box">
                            <div className="image-box">
                                <figure className="thumb"><img src="/images/resource/test-thumb-7.jpg" title='Netvions' /></figure>
                    ...
                    <SwiperSlide className="testimonial-block-three">
                        <div className="inner-box">
                            <div className="image-box">
                                <figure className="thumb"><img src="/images/resource/test-thumb-8.jpg" title='Netvions' /></figure>
                                <span className="icon fa fa-quote-right" />
                            </div>
                            <div className="content-box">
                                <div className="info-box">
