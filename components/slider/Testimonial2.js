                    ...
                    <SwiperSlide className="testimonial-block swiper-slide">
                        <div className="row">
                            ...
                            <div className="image-column col-lg-6 col-md-12">
                                <figure className="image"><img src="/images/resource/testimonial-1.png" title='Netvions' /></figure>
                            </div>
                        </div>
                    </SwiperSlide>
                    {/* Testimonial Block Two */}
            ...
            {/* <div className="swiper-container testimonial-thumbs">
                ...
                >
                    <SwiperSlide className="swiper-slide testimonial-thumb">
                        <figure className="image"><img src="/images/resource/testi-thumb-2.jpg" title='Netvions' /></figure>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide testimonial-thumb">
                        <figure className="image"><img src="/images/resource/testi-thumb-1.jpg" title='Netvions' /></figure>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide testimonial-thumb">
                        <figure className="image"><img src="/images/resource/testi-thumb-3.jpg" title='Netvions' /></figure>
                    </SwiperSlide>
                </Swiper>
            </div> */}
        </>
